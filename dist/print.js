...
var Browser = {
  ...
  getFirefoxMajorVersion: function getFirefoxMajorVersion(userAgent) {
    userAgent = userAgent || navigator.userAgent;
    var firefoxVersionRegex = /firefox\/(\S+)/;
    var match = userAgent.toLowerCase().match(firefoxVersionRegex);
    if (match) {
      return match[1].split('.').map(function (x) {
        return parseInt(x);
      })[0];
    }
  },
...
/*!*****************************!*\
  !*** ./src/js/functions.js ***!
  \*****************************/
/*! exports provided: addWrapper, capitalizePrint, collectStyles, addHeader, addFooter, cleanUp, isRawHTML */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function addFooter(printElement, params) {
  ...
  if (isRawHTML(params.footer)) {
    ...
    var footerElement = document.createElement('h1');

    // Create footer text node
    var footerNode = document.createTextNode(params.footer);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  print: function print(params, printFrame) {
    ...
    // Add footer
    if (params.footer) {
      Object(_functions__WEBPACK_IMPORTED_MODULE_0__["addFooter"])(params.printableElement, params);
    }
  ...
  send: function send(params, printFrame) {
    ...
    iframeElement.onload = function () {
      if (params.type === 'pdf') {
        ...
        if (_browser__WEBPACK_IMPORTED_MODULE_0__["default"].isFirefox() && _browser__WEBPACK_IMPORTED_MODULE_0__["default"].getFirefoxMajorVersion() < 110) {
          setTimeout(function () {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  print: function print(params, printFrame) {
    ...
    // Add header
    if (params.header) {
      Object(_functions__WEBPACK_IMPORTED_MODULE_1__["addHeader"])(params.printableElement, params);
    }

    // Add footer
    if (params.footer) {
      Object(_functions__WEBPACK_IMPORTED_MODULE_1__["addFooter"])(params.printableElement, params);
    }
